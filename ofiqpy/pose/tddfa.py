"""3DDFA-V2 head pose derived from HeadPose3DDFAV2.cpp.
...
PARAM_MEAN = np.array(
    [3.4926363e-04, 2.5279013e-07, -6.8751979e-07, 6.0167957e01, -6.2955132e-07, 5.7572004e-04, -5.0853912e-05], np.float32
)
PARAM_STD = np.array(
    [1.76321526e-04, 6.73794348e-05, 4.47084894e-04, 2.65502319e01, 1.23137695e-04, 4.49302170e-05, 7.92367064e-05], np.float32
)
THRES = 0.9975
...
class TDDFAPose:
    ...
    def estimate(self, image: np.ndarray, box) -> tuple[float, float, float]:
        ...
        r0 = p[[0, 1, 2]].astype(np.float32)
        r1 = p[[4, 5, 6]].astype(np.float32)
